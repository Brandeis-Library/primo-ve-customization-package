...
// Adds the chat button
  (function() {
    ...
    lc.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'v2.libanswers.com/load_chat.php?hash=8695fcdfdfdf1ec2b50aabde6d1afd61';
...
(function(s,o,g,a,m){a=s.createElement(o),m=s.head;a.async=1;a.src=g;m.appendChild(a);a.onload=function(){ var x=document.getElementById('s-la-widget-st-1305');x && x.firstElementChild.removeAttribute('href');};})(document,'script','https://api2.libanswers.com/1.0/status/widgets/1305');
